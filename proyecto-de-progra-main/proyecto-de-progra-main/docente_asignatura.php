...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form name="sigup" action="designar_curso.php" method="POST">
     ...
     <br>
     Codigo_Docente  :<input class="Rcontrols" type="text" name="codigodocente" value="" placeholder="2009920182">
     <br>
     Ciclo Academico  :<input class="Rcontrols" type="text" name="ciclo" value="" placeholder="2019-I">
     <br>
     <br>
